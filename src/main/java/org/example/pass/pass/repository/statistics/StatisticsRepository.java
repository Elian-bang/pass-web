package org.example.pass.pass.repository.statistics;

import org.example.pass.pass.service.statistics.AggregatedStatistics;
...
public interface StatisticsRepository extends JpaRepository<StatisticsEntity, Integer> {
    ...
    @Query(value = "SELECT new org.example.pass.pass.service.statistics.AggregatedStatistics(s.statisticsAt, SUM(s.allCount), SUM(s.attendedCount), SUM(s.cancelledCount)) " +
